...
## 🎯 목표
- **프로그래밍 실력 향상**: 알고리즘과 자료 구조를 더 공부하고, 다양한 프로그래밍 언어에 익숙해지기.
- **웹 개발 능력 강화**: HTML, CSS, JavaScript, React 등 웹 기술에 대해 더 깊이 배우고 프로젝트를 더 많이 만들어보기.
- **앱 개발**: Android 앱 개발을 공부하고, 실제로 앱을 출시할 수 있도록 도전하기.
